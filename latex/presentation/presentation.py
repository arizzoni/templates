...
class Plot:
    ...
    def get_eng_formatter(self, arg):
        return EngFormatter(unit=r"$\unit{%s}$" % (arg), sep=r"\,")
...
rc.update(
    {
        ...
        "pgf.preamble": "\n".join(
            [
                r"\RequirePackage{luatexbase}",
                r"\RequirePackage{luatextra}",
                r"\RequirePackage{luacode}",
                r"\RequirePackage{xcolor}",
                r"\RequirePackage{luacolor}",
                r"\usepackage{polyglossia}",
                r"\setdefaultlanguage[variant=american]{english}",
                r"\RequirePackage{linebreaker}",
